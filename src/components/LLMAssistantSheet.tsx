...
interface LLMAssistantSheetProps {
  ...
  action: "pause" | "cancel" | "renew" | "recover" | null;
  onClose: () => void;
  onCompleted: (subscriptionId: string, action: "pause" | "cancel" | "renew" | "recover") => void;
}
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {action === "cancel" ? "Cancel" : 
                 ...
                 "Pause"} {subscription.name || subscription.provider}
              </p>
            </div>
          </div>
        </SheetHeader>
